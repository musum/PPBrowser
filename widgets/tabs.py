...
from PyQt5.QtCore import (QByteArray, QEvent, QMimeData, QPoint, Qt)
from PyQt5.QtCore import pyqtSignal as Signal
from PyQt5.QtCore import pyqtSlot as Slot
from PyQt5.QtWidgets import (QApplication, QHBoxLayout, QMenu, QTabBar,
                            QTabWidget, QWidget, QLineEdit)

# Local imports
from utils import icon_manager as ima
from utils.qthelpers import (add_actions, create_action, create_toolbutton)
...
class TabBar(QTabBar):
    ...
    def dropEvent(self, event):
        ...
        if int(mimeData.data("tabbar-id")) != id(self):
            tabwidget_from = mimeData.data("tabwidget-id")
...
class Tabs(BaseTabs):
    ...
    def move_tab_from_another_tabwidget(self, tabwidget_from,
        ...
        # by long all the time is not working on some 32bit platforms 
        # (see Issue 1094, Issue 1098)
        self.sig_move_tab.emit(tabwidget_from, id(self),
                               index_from, index_to)
