...
from utils.qthelpers import create_action, toggle_actions
...
class PluginMixin(object):
    ...
    def __init__(self, main=None, **kwds):
        ...
        super(PluginMixin, self).__init__(**kwds)
        ...
        # try:
        #     self.shortcut = CONF.get('shortcuts', '_/switch to %s' % self.CONF_SECTION)
